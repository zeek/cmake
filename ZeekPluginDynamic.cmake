...
function(zeek_add_dynamic_plugin ns name)
    ...
    if (NOT EXISTS "${ZEEK_PLUGIN_SCRIPTS_PATH}")
        message(FATAL_ERROR "Cannot build dynamic plugins: ZEEK_PLUGIN_SCRIPTS_PATH is undefined or invalid")
    endif ()
    ...
    if (IS_DIRECTORY "${scripts_src}")
        ...
        add_custom_target(
            ${symlink_target}
            COMMAND "${CMAKE_COMMAND}" -E create_symlink "${scripts_src}" "${scripts_bin}")
    ...
    add_custom_command(
        ...
        COMMAND ${ZEEK_PLUGIN_SCRIPTS_PATH}/zeek-plugin-create-package.sh ${canon_name} ${DIST_FILES}
